		...
		// Status Column
		{
			...
			values: [
				...
				},
				{
					...
					default: '',
					description: 'Click to load available status values from the selected column',
					hint: 'Values are cached for 5 minutes. Reload workflow to refresh.',
				},
			],
		},
		...
		// Dropdown Column
		{
			...
			values: [
				...
				},
				{
					...
					default: [],
					description: 'Click to load available dropdown values from the selected column',
					hint: 'Values are cached for 5 minutes. Reload workflow to refresh.',
				},
			],
		},
		...
		// Board Relation Column
		{
			...
			values: [
				...
				},
				{
					...
					default: [],
					description: 'Click to load items from the linked board(s)',
					hint: 'Values are cached for 5 minutes. Reload workflow to refresh.',
				},
			],
		},
