		...
		// Status Column
		{
			...
			values: [
				...
				},
				{
					...
					default: '',
					description: 'Select the status value to set',
					hint: 'Values load automatically when you click this field',
				},
			],
		},
		...
		// Dropdown Column
		{
			...
			values: [
				...
				},
				{
					...
					default: [],
					description: 'Select dropdown values (multi-select supported)',
					hint: 'Values load automatically when you click this field',
				},
			],
		},
		...
		// Board Relation Column
		{
			...
			values: [
				...
				},
				{
					...
					default: [],
					description: 'Select items from the linked board(s)',
					hint: 'Items load automatically when you click this field',
				},
			],
		},
